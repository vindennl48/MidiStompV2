...
/** 
  ...
  */
  ...
  #define ShiftRegisterPWM_DATA_MASK _BV(3)
  //#define ShiftRegisterPWM_DATA_MASK 0B00001000
#endif
  ...
  #define ShiftRegisterPWM_CLOCK_MASK _BV(4)
  //#define ShiftRegisterPWM_CLOCK_MASK 0B00010000
#endif
  ...
  #define ShiftRegisterPWM_LATCH_MASK _BV(1)
  //#define ShiftRegisterPWM_LATCH_MASK 0B00000010
#endif
...
public:
  ...
  void setup() {
    PIN_B9_SETUP_OUTPUT;   // LATCH
    PIN_B12_SETUP_OUTPUT;  // CLOCK
    PIN_B11_SETUP_OUTPUT;  // DATA
    interrupt(UpdateFrequency::Slow);
  };
